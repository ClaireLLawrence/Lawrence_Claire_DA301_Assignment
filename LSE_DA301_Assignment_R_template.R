...
qplot(y=Global_Sales, colour=Platform, data=sales_data3)
qplot(y=NA_Sales, colour=Platform, data=sales_data3)
qplot(y=EU_Sales, colour=Platform, data=sales_data3)
...
## 2b) Histograms
# Create histograms.
qplot(Global_Sales, data=sales_data3)



## 2c) Boxplots
# Create boxplots.
qplot(Platform, Global_Sales, data=sales_data3, geom='boxplot')
